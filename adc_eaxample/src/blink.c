...
//	timerInit.prescale = timerPrescale64;	//HFPERCLK undivided
	TIMER_TopSet(TIMER0, 25000); //this will make the LOG_SIG ADC run at 25MHz/25000 = ~1kHz
...
void adc_config(void)
{
	...
	init_scan.input = ADC_SCANCTRL_INPUTMASK_CH0 | ADC_SCANCTRL_INPUTMASK_CH1 | ADC_SCANCTRL_INPUTMASK_CH2;
